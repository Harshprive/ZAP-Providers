  ...
  <TouchableOpacity onPress={onPress} style={styles.card}>
    <View style={styles.cardContent}>
      ...
      <View style={styles.detailRow}>
        ...
        <Text style={styles.value}>24-09-2025</Text>
      </View>
      {status === "Seen" && (
        <View style={styles.detailRow}>
    ...
    <View
      style={[
        styles.statusBadge,
        status === "Un-seen" ? styles.unseenBadge : styles.seenBadge,
      ]}
    >
...
export default function IssuesScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <HeaderTitle />
      {/* Page Title */}
      <Text style={styles.pageTitle}>Issues</Text>
      {/* Request Cards */}
