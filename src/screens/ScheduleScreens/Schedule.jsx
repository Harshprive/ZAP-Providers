  ...
  const schedules = [
    {
      ...
      confirmed: true,
      problem:
        "Lorem ipsum dolor sit amet consectetur. In elementum in tempus massa tellus nullam nulla quis. Sed volutpat id mi ut diam. Faucibus lectus sit quam nascetutr diam donec pharetra fermentum semper...",
    },
    {
      service: "Washing machine Repair",
      location: "Downtown Office Complex",
              ...
              <>
                ...
                <View style={styles.buttonContainer}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("ClientLocation")}
                  >
                    <Text style={styles.confirmText}>Start </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={styles.prerequisitesButton}
